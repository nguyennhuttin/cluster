...
if start_from_checkpoint:
    ...
    if os.path.isfile(save_path):
        ...
        training_loss_logger = check_point['training_loss_logger']
        validation_acc_logger = check_point['validation_acc_logger']
        training_acc_logger = check_point['training_acc_logger']
...
# a=torch.load('./Models/'+model_name+'.pt')['model_state_dict'] # check the dictionary for what epoch
# #print(a) # use this orderdict like a dictionary

# model_pytorch = CNN(alphabet).to(device) # using the best model
# model_pytorch.load_state_dict(a)
# model_pytorch.eval()
# fx_check,y_check,acc =evaluate2(model_pytorch, device, data_loader_test)
# print('max acc: ',acc)
