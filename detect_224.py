...
save_path_signals = os.path.join(folder_dir+"/data", model_name + "_signal.pt")
save_path_labels = os.path.join(folder_dir+"/data", model_name + "_labels.pt")
save_path_real_signals = os.path.join(
    folder_dir+"/data", model_name + "real_signal.pt")
save_path_real_labels = os.path.join(
    folder_dir+"/data", model_name + "real_labels.pt")
printLog('s', 'l', 'rs', 'rl')
